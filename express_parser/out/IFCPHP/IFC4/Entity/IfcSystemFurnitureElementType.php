...
class IfcSystemFurnitureElementType extends IfcFurnishingElementType{
	...
	static public $elementName = 'IFCSYSTEMFURNITUREELEMENTTYPE';

	static public $translationFR = 'Type d\'élément de l\'ameublement';
	...
	static public $params = [
		...
		[
			'name' => 'PredefinedType',
			'class' => 'Type\IfcSystemFurnitureElementTypeEnum',
			'type' => 'object',
			'optional' => true,
		],
	];
